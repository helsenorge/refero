...
import { generateSectionContent, getSidebarElements } from './resources/referoSidebarResources';
...
const FormFillerSidebar = ({ questionnaire }: Props): JSX.Element => {
  ...
  return (
    ...
    >
      <button className="formFillerSidebar-button" onClick={(): void => setIsSidebarViewEnabled(!isSidebarViewEnabled)}>
        {'?'}
      </button>
